...
public class Drive extends SubsystemBase {
  private static final double DRIVE_BASE_RADIUS =
      Math.hypot(DriveConstants.kTrackWidth / 2.0, DriveConstants.kTrackWidth / 2.0);
  ...
  public Drive(
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig(
            DriveConstants.kMaxSpeedMetersPerSecond, DRIVE_BASE_RADIUS, new ReplanningConfig()),
        () ->
