package frc.robot.subsystems.old_drive;
...
import frc.robot.subsystems.old_drive.ctre.SwerveDrivetrain.SwerveDriveState;
import frc.robot.subsystems.old_drive.ctre.SwerveModule.DriveRequestType;
import frc.robot.subsystems.old_drive.ctre.SwerveModule.SteerRequestType;
import frc.robot.subsystems.old_drive.ctre.SwerveRequest;
import frc.robot.subsystems.old_drive.gyro.GyroIO;
import frc.robot.subsystems.old_drive.gyro.GyroInputsAutoLogged;
...
private SwerveSetpoint currentSetpoint =
  ...
  public void addVisionMeasurement(VisionObservation observation){
    ...
    double totalMovement = Math.abs(this.getReplayChassisSpeeds().omegaRadiansPerSecond) + Math.abs(this.getChassisSpeeds().vxMetersPerSecond) + Math.abs(this.getChassisSpeeds().vyMetersPerSecond);
