...
public enum Note {
    ...
    FOUR(FieldConstants.StagingLocations.centerlineTranslations[0]),
    FIVE(FieldConstants.StagingLocations.centerlineTranslations[1]),
    SIX(FieldConstants.StagingLocations.centerlineTranslations[2]), 
    SEVEN(FieldConstants.StagingLocations.centerlineTranslations[3]), 
    EIGHT(FieldConstants.StagingLocations.centerlineTranslations[4]);
