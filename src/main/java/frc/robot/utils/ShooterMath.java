...
public class ShooterMath {
    ...
    public void setUpTreeMap(){
        ...
        m_distanceAngle.put(Units.inchesToMeters(12)+constantAddition,50.0);
        m_distanceAngle.put(Units.inchesToMeters(24)+constantAddition,45.0);
        m_distanceAngle.put(Units.inchesToMeters(36)+constantAddition,42.0);
        m_distanceAngle.put(Units.inchesToMeters(48)+constantAddition,38.0);
        m_distanceAngle.put(Units.inchesToMeters(60)+constantAddition,37.0);
        m_distanceAngle.put(Units.inchesToMeters(72)+constantAddition,34.25);
        ...
        m_distanceAngle.put(Units.inchesToMeters(160)+constantAddition,23.5);
        m_distanceAngle.put(Units.inchesToMeters(180)+constantAddition,23.0);
        m_distanceAngle.put(Units.inchesToMeters(200)+constantAddition,21.5);
        m_distanceAngle.put(Units.inchesToMeters(220)+constantAddition,21.0);
        ...
        m_shootSpeedRight.put(Units.inchesToMeters(72)+constantAddition,13.5);
        m_shootSpeedRight.put(Units.inchesToMeters(84)+constantAddition,13.5);
        m_shootSpeedRight.put(Units.inchesToMeters(96)+constantAddition,13.5);
        m_shootSpeedRight.put(Units.inchesToMeters(108)+constantAddition,14.0);
        m_shootSpeedRight.put(Units.inchesToMeters(120)+constantAddition,14.5);
        m_shootSpeedRight.put(Units.inchesToMeters(140)+constantAddition,15.0);
        m_shootSpeedRight.put(Units.inchesToMeters(160)+constantAddition,15.0);
        m_shootSpeedRight.put(Units.inchesToMeters(180)+constantAddition,15.5);
        m_shootSpeedRight.put(Units.inchesToMeters(200)+constantAddition,15.5);
        m_shootSpeedRight.put(Units.inchesToMeters(220)+constantAddition,16.75);
        ...
        m_shootSpeedLeft.put(Units.inchesToMeters(72)+constantAddition,10.5);
        m_shootSpeedLeft.put(Units.inchesToMeters(84)+constantAddition,10.5);
        m_shootSpeedLeft.put(Units.inchesToMeters(96)+constantAddition,10.5);
        m_shootSpeedLeft.put(Units.inchesToMeters(108)+constantAddition,11.0);
        m_shootSpeedLeft.put(Units.inchesToMeters(120)+constantAddition,11.5);
        m_shootSpeedLeft.put(Units.inchesToMeters(140)+constantAddition,11.5);
        m_shootSpeedLeft.put(Units.inchesToMeters(160)+constantAddition,12.0);
        ...
        m_shootSpeedLeft.put(Units.inchesToMeters(220)+constantAddition,14.0);
