...
public class ShooterMath {
    ...
    public void setUpTreeMap(){
        ...
        m_distanceAngle.put(Units.inchesToMeters(36)+constantAddition,41.0);
        m_distanceAngle.put(Units.inchesToMeters(48)+constantAddition,37.75);
        ...
        m_shootSpeedRight.put(Units.inchesToMeters(160)+constantAddition,15.5);
